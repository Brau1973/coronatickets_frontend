...
**In this particular repository** there is the frontend of the project, where a web interface with login for spectators and artists is offered, but also the option to navigate some features of the application as a visitor without being logged in.
It is from this layer that the WebServices exposed from the backend are consumed and the results of the operations requested to the server are displayed.
