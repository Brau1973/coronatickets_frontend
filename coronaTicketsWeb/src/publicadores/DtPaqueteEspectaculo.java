...
public class DtPaqueteEspectaculo implements java.io.Serializable {
	...
	public DtPaqueteEspectaculo(java.lang.String nombre, java.lang.String descripcion, java.util.Calendar fechaInicio, java.util.Calendar fechaFin, java.util.Calendar fechaAlta, int descuento, publicadores.DtEspectaculo[] espectaculos) {
		this.nombre = nombre;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DtPaqueteEspectaculo))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.nombre == null && other.getNombre() == null) || (this.nombre != null && this.nombre.equals(other.getNombre()))) && ((this.descripcion == null && other.getDescripcion() == null) || (this.descripcion != null && this.descripcion.equals(other.getDescripcion())))
				&& ((this.fechaInicio == null && other.getFechaInicio() == null) || (this.fechaInicio != null && this.fechaInicio.equals(other.getFechaInicio()))) && ((this.fechaFin == null && other.getFechaFin() == null) || (this.fechaFin != null && this.fechaFin.equals(other.getFechaFin())))
				&& ((this.fechaAlta == null && other.getFechaAlta() == null) || (this.fechaAlta != null && this.fechaAlta.equals(other.getFechaAlta()))) && this.descuento == other.getDescuento()
				&& ((this.espectaculos == null && other.getEspectaculos() == null) || (this.espectaculos != null && java.util.Arrays.equals(this.espectaculos, other.getEspectaculos())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getEspectaculos() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getEspectaculos()); i++) {
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(DtPaqueteEspectaculo.class, true);
