...
public class DtPlataforma implements java.io.Serializable {
	...
	public DtPlataforma(java.lang.String nombre, java.lang.String descripcion, java.lang.String url, publicadores.DtEspectaculo[] espectaculo) {
		this.nombre = nombre;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DtPlataforma))
			return false;
		...
		_equals = true && ((this.nombre == null && other.getNombre() == null) || (this.nombre != null && this.nombre.equals(other.getNombre()))) && ((this.descripcion == null && other.getDescripcion() == null) || (this.descripcion != null && this.descripcion.equals(other.getDescripcion())))
				&& ((this.url == null && other.getUrl() == null) || (this.url != null && this.url.equals(other.getUrl()))) && ((this.espectaculo == null && other.getEspectaculo() == null) || (this.espectaculo != null && java.util.Arrays.equals(this.espectaculo, other.getEspectaculo())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getEspectaculo() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getEspectaculo()); i++) {
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(DtPlataforma.class, true);
