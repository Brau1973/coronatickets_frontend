...
public class ConsultaPaqueteEspectaculo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// IControladorEspectaculo iconE =
		// Fabrica.getInstancia().getIControladorEspectaculo();
		// IControladorPaquete iconPaq =
		// Fabrica.getInstancia().getIControladorPaquete();
		...
		if (strPaquete != null) {
			if (request.getParameter("boton").equals("selPaquete")) {
				...
				// dtPaqueteEsp = new DtPaqueteEspectaculo(listPaquetes.getNombre(),
				// listPaquetes.getDescripcion(), listPaquetes.getFechaInicio(),
				// listPaquetes.getFechaFin(), listPaquetes.getFechaAlta(),
				// listPaquetes.getDescuento());
				...
				// listDtEspectaculos=new DtEspectaculo(listEspectaculos.ge, plataforma, nombre,
				// descripcion, duracion, cantMin, cantMax, url, costo, registro)
